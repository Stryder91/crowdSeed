...
import { ProfilIcon } from "../icons/svg/ProfilIcon";
import { NumberBadge } from "../icons/NumberBadge";
...
export const Sidebar = ({ children }) => {
	...
	const _navigate = (dest) => {
		console.log("hello");
    navigate(dest);
  }


	console.log("changing state from Sidebar", state);
			...
			<div className="flex flex-no-wrap">
				<div className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
					<div className="px-8">
						...
						<ul className="mt-12">
							<li onClick={() => _navigate('/')} className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
								<a  className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
									<ProfilIcon />
									<span className="text-sm ml-2">{t("catg.housing")}</span>
								</a>
								<NumberBadge number={state.housing_number}/>
							</li>
							<li onClick={() => _navigate('create')} className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
								<a  className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
									<ProfilIcon />
									<span className="text-sm ml-2">{t("catg.create")}</span>
								</a>
							</li>
							<li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
								<a  className="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
									<ProfilIcon />
									<span className="text-sm ml-2">{t("catg.rent")}</span>
								</a>
							</li>
							<li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
								<a  className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
									<ProfilIcon />
									<span className="text-sm ml-2">{t("catg.profil")}</span>
								</a>
							</li>
				...
				<div className="container mx-auto py-2 h-64 md:w-4/5 w-11/12 px-6">
					{ children }
				</div>
			</div>
		</dh-component>
